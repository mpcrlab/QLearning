...
Sfinal = [numrows,numcols]; %Set the final location at (8,8). The agent will receive the reward in this location 
...
%    i
    s1 = [1,1];   % The initial state is (1,1)
...
s1 = [1,1]; % start at the initial position
